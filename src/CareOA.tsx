...
const CareOA=(props:IProps)=> {
    ...
    return (
        <div
            className="fixed bottom-0 z-[9999999] p-0 m-0 w-scrren h-screen flex flex-cols items-center justify-center bg-[#222222]">
            <div className="w-[90%] rounded-xl bg-white px-4">
                <div className=" flex flex-col  w-full h-full items-center  my-10 gap-2">
                    ...
                    <div className="zalo-follow-only-button w-100 h-100"
                         data-oaid={ID_OA}
